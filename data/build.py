...
def build_loader(config):
    ...
    Returns:
        ...
        data_loader_val (DataLoader): Validation data loader.
        mixup_fn (Mixup): Mixup function if active.
    """
    config.defrost()
...
def build_dataset(is_train, config):
    ...
    Args:
        is_train (bool): Whether it's a training dataset or not.
        config (Namespace): Configuration parameters.
...
def build_transform(is_train, config):
    ...
    Args:
        is_train (bool): Whether it's a training transform or not.
        config (Namespace): Configuration parameters.

    Returns:
        transform (Compose): Composed transforms.
    """
